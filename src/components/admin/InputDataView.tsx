...
export default function InputDataView({
  ...
  const handleAddCourierRow = () => {
    const newCourier: Courier = {
      id: crypto.randomUUID(),
      name: `Kurir ${localCouriers.length + 1}`,
      capacity: 40,
      active: true,
        ...
        {step === 1 ? (
          <Card className="p-6 space-y-4">
            <div className="flex items-center justify-between mb-2">
              <div>
                <h2 className="text-lg font-semibold">Data Kurir</h2>
                <p className="text-xs text-muted-foreground">
                  Masukkan nama kurir dan kapasitas berat maksimum.
                </p>
              </div>
              <Button size="sm" onClick={handleAddCourierRow}>
                + Tambah Kurir
              </Button>
            </div>
            ...
            {localCouriers.length === 0 ? (
              <p className="text-sm text-muted-foreground">
                Belum ada kurir. Tambahkan kurir pertama Anda.
              </p>
            ) : (
              <div className="space-y-3">
                {localCouriers.map(courier => (
                  <div
                    key={courier.id}
                    className="grid grid-cols-1 md:grid-cols-[2fr,1fr,1fr,auto] gap-2 items-end border rounded-lg p-3"
                  >
                    <div>
            ...
            <div className="flex items-center justify-between pt-4 border-t mt-2">
              ...
              <Button onClick={handleSaveCouriersAndNext}>
