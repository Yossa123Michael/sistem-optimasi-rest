...
import MapView from '@/components/maps/MapView' // kalau belum mau pakai, bisa diganti div placeholder
...
export default function CourierPackageListView({
  ...
  const courierPackages = packages
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      ...
                      className={
                        pkg.status === 'delivered' ? 'bg-accent' : ''
                      }
                    >
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedPackage.locationDetail}
                  </p>
                </div>
              </div>

              {/* peta – kalau MapView belum siap, ganti div biasa */}
